...
AAIControllerAssassin::AAIControllerAssassin()
{
	static ConstructorHelpers::FObjectFinder<UBlackboardData> BBDataRef(TEXT("/Script/AIModule.BlackboardData'/Game/No-Face/AI/Melee/BB_MeleeAssassin.BB_MeleeAssassin'"));
	if (BBDataRef.Object)
	{
		BBData = BBDataRef.Object;
	}
	static ConstructorHelpers::FObjectFinder<UBehaviorTree> BTDataRef(TEXT("/Script/AIModule.BehaviorTree'/Game/No-Face/AI/Melee/BT_MeleeAssassin.BT_MeleeAssassin'"));
	if (BTDataRef.Object)
	{
	...
	AIPerception->OnTargetPerceptionUpdated.AddDynamic(this, &AAIControllerAssassin::OnPerceptionUpdated);
}

void AAIControllerAssassin::OnPerceptionUpdated(AActor* Actor, FAIStimulus Stimulus)
{
...
FAIStimulus AAIControllerAssassin::CanSenseActor(AActor* Actor, EAIPerceptionSense AIPerceptionSense)
{
...
void AAIControllerAssassin::HandleSenseSight(AActor* Actor, const FAIStimulus& AIStimulus)
{
...
void AAIControllerAssassin::HandleSenseDamage(AActor* Actor, const FAIStimulus& AIStimulus)
{
	if (AIStimulus.WasSuccessfullySensed())
	{
