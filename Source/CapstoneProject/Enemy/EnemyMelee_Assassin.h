...
#include "EnemyMelee_Assassin.generated.h"

/**
 * 
 */
UCLASS()
class CAPSTONEPROJECT_API AEnemyMelee_Assassin : public AEnemyBase
{
	GENERATED_BODY()
	
public:
	AEnemyMelee_Assassin();
...
/* 유틸리티 섹션 */
private:
	class AAIControllerAssassin* GetMyController();
